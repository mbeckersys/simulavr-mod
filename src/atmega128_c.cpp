...
AVR_REGISTER(atmega128c, AvrDevice_atmega128_c)

AvrDevice_atmega128_c::~AvrDevice_atmega128_c() {
    delete acomp;
    delete timer3;
    ...
    AvrDevice(224, 4096, 0xef00, 256*1024)
{
    ...
    cache_insn = new HWCache(this, 64, 32, 4, irqSystem, 4096, 35, true);  // last IRQ is for i-cache
